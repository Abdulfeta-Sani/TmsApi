...
public static class DataSeeder
{
    ...
    [
        ...
        ("TMS-2026-0004", "Diana Prince",    3.95m, true),
        ("TMS-2026-0005", "Evan Wright",     2.50m, false),
        ("TMS-2026-0006", "Fatima Hassan",   3.75m, true),
        ("TMS-2026-0007", "Gabriel Tesfaye", 3.10m, false),
        ("TMS-2026-0008", "Hannah Lee",      3.55m, true),
        ("TMS-2026-0009", "Isaac Kim",       2.70m, false),
        ("TMS-2026-0010", "Julia Roberts",   3.90m, true),
    ];
